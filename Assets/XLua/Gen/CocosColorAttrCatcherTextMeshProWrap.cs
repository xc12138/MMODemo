...
namespace XLua.CSObjectWrap
{
    ...
    public class CocosColorAttrCatcherTextMeshProWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Cocos.ColorAttrCatcherTextMeshPro);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Cocos.ColorAttrCatcherTextMeshPro gen_ret = new Cocos.ColorAttrCatcherTextMeshPro();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Cocos.ColorAttrCatcherTextMeshPro constructor!");
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Transform _target = (UnityEngine.Transform)translator.GetObject(L, 1, typeof(UnityEngine.Transform));
                        ...
                        UnityEngine.Color gen_ret = Cocos.ColorAttrCatcherTextMeshPro.GetColorFunc( _target );
        ...
        static int _m_SetColorFunc_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    Cocos.ColorAttrCatcherTextMeshPro.SetColorFunc( _target, _color );
        ...
        static int _g_get_GetColor(RealStatePtr L)
        {
		    try {
                ...
                Cocos.ColorAttrCatcherTextMeshPro gen_to_be_invoked = (Cocos.ColorAttrCatcherTextMeshPro)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_Ins(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, Cocos.ColorAttrCatcherTextMeshPro.Ins);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_Ins(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    Cocos.ColorAttrCatcherTextMeshPro.Ins = (Cocos.ColorAttrCatcherTextMeshPro)translator.GetObject(L, 1, typeof(Cocos.ColorAttrCatcherTextMeshPro));
