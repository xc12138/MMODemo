...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityMMOBeHitEffectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityMMO.BeHitEffect);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityMMO.BeHitEffect gen_ret = new UnityMMO.BeHitEffect();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityMMO.BeHitEffect constructor!");
        ...
        static int _m_IsShowing(RealStatePtr L)
        {
		    try {
                ...
                UnityMMO.BeHitEffect gen_to_be_invoked = (UnityMMO.BeHitEffect)translator.FastGetCSObj(L, 1);
