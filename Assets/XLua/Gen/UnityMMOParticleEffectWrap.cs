...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityMMOParticleEffectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityMMO.ParticleEffect);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityMMO.ParticleEffect gen_ret = new UnityMMO.ParticleEffect();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityMMO.ParticleEffect constructor!");
        ...
        static int _m_IsShowing(RealStatePtr L)
        {
		    try {
                ...
                UnityMMO.ParticleEffect gen_to_be_invoked = (UnityMMO.ParticleEffect)translator.FastGetCSObj(L, 1);
