...
namespace XLua.CSObjectWrap
{
    ...
    public class CocosFadeInWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Cocos.FadeIn);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Cocos.FadeIn gen_ret = new Cocos.FadeIn();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Cocos.FadeIn constructor!");
        ...
        static int _m_Create_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)&& translator.Assignable<Cocos.IColorAttrCatcher>(L, 2)) 
                {
                    ...
                    Cocos.IColorAttrCatcher _attrCatcher = (Cocos.IColorAttrCatcher)translator.GetObject(L, 2, typeof(Cocos.IColorAttrCatcher));
                        ...
                        Cocos.FadeIn gen_ret = Cocos.FadeIn.Create( _d, _attrCatcher );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 1&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)) 
                {
                    float _d = (float)LuaAPI.lua_tonumber(L, 1);
                        ...
                        Cocos.FadeIn gen_ret = Cocos.FadeIn.Create( _d );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Cocos.FadeIn.Create!");
        ...
        static int _m_Clone(RealStatePtr L)
        {
		    try {
                ...
                Cocos.FadeIn gen_to_be_invoked = (Cocos.FadeIn)translator.FastGetCSObj(L, 1);
