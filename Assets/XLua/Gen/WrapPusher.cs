...
namespace XLua
{
    public partial class ObjectTranslator
    {
        ...
        class IniterAdderUnityEngineVector2
        {
			...
			static void Init(LuaEnv luaenv, ObjectTranslator translator)
			{
				...
				translator.RegisterPushAndGetAndUpdate<Cocos.CoordinateStyle>(translator.PushCocosCoordinateStyle, translator.Get, translator.UpdateCocosCoordinateStyle);
				...
				translator.RegisterPushAndGetAndUpdate<UnityMMO.EffectStatus>(translator.PushUnityMMOEffectStatus, translator.Get, translator.UpdateUnityMMOEffectStatus);
        ...
        int CocosCoordinateStyle_TypeID = -1;
		int CocosCoordinateStyle_EnumRef = -1;
        
        public void PushCocosCoordinateStyle(RealStatePtr L, Cocos.CoordinateStyle val)
        {
            if (CocosCoordinateStyle_TypeID == -1)
            {
			    bool is_first;
                CocosCoordinateStyle_TypeID = getTypeId(L, typeof(Cocos.CoordinateStyle), out is_first);
				
				if (CocosCoordinateStyle_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(Cocos.CoordinateStyle));
				    CocosCoordinateStyle_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, CocosCoordinateStyle_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, CocosCoordinateStyle_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for Cocos.CoordinateStyle ,value="+val);
            }
			
			LuaAPI.lua_getref(L, CocosCoordinateStyle_EnumRef);
			LuaAPI.lua_pushvalue(L, -2);
			LuaAPI.xlua_rawseti(L, -2, (int)val);
			LuaAPI.lua_pop(L, 1);
        ...
        public void Get(RealStatePtr L, int index, out Cocos.CoordinateStyle val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != CocosCoordinateStyle_TypeID)
				{
				    throw new Exception("invalid userdata for Cocos.CoordinateStyle");
				}
                ...
                if (!CopyByValue.UnPack(buff, 0, out e))
                {
                    throw new Exception("unpack fail for Cocos.CoordinateStyle");
                }
				val = (Cocos.CoordinateStyle)e;
                
            }
            else
            {
                val = (Cocos.CoordinateStyle)objectCasters.GetCaster(typeof(Cocos.CoordinateStyle))(L, index, null);
            }
        }
		
        public void UpdateCocosCoordinateStyle(RealStatePtr L, int index, Cocos.CoordinateStyle val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for Cocos.CoordinateStyle ,value="+val);
                }
            }
        ...
        int UnityMMOEffectStatus_TypeID = -1;
		int UnityMMOEffectStatus_EnumRef = -1;
        
        public void PushUnityMMOEffectStatus(RealStatePtr L, UnityMMO.EffectStatus val)
        {
            if (UnityMMOEffectStatus_TypeID == -1)
            {
			    bool is_first;
                UnityMMOEffectStatus_TypeID = getTypeId(L, typeof(UnityMMO.EffectStatus), out is_first);
				
				if (UnityMMOEffectStatus_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(UnityMMO.EffectStatus));
				    UnityMMOEffectStatus_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, UnityMMOEffectStatus_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, UnityMMOEffectStatus_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for UnityMMO.EffectStatus ,value="+val);
            }
			
			LuaAPI.lua_getref(L, UnityMMOEffectStatus_EnumRef);
			LuaAPI.lua_pushvalue(L, -2);
			LuaAPI.xlua_rawseti(L, -2, (int)val);
			LuaAPI.lua_pop(L, 1);
        ...
        public void Get(RealStatePtr L, int index, out UnityMMO.EffectStatus val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != UnityMMOEffectStatus_TypeID)
				{
				    throw new Exception("invalid userdata for UnityMMO.EffectStatus");
				}
                ...
                if (!CopyByValue.UnPack(buff, 0, out e))
                {
                    throw new Exception("unpack fail for UnityMMO.EffectStatus");
                }
				val = (UnityMMO.EffectStatus)e;
                
            }
            else
            {
                val = (UnityMMO.EffectStatus)objectCasters.GetCaster(typeof(UnityMMO.EffectStatus))(L, index, null);
            }
        }
		
        public void UpdateUnityMMOEffectStatus(RealStatePtr L, int index, UnityMMO.EffectStatus val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for UnityMMO.EffectStatus ,value="+val);
                }
            }
	...
	public partial class StaticLuaCallbacks
    {
	    internal static bool __tryArrayGet(Type type, RealStatePtr L, ObjectTranslator translator, object obj, int index)
		{
			...
			else if (type == typeof(Cocos.CoordinateStyle[]))
			{
			    Cocos.CoordinateStyle[] array = obj as Cocos.CoordinateStyle[];
				translator.PushCocosCoordinateStyle(L, array[index]);
				return true;
			}
			...
			else if (type == typeof(UnityMMO.EffectStatus[]))
			{
			    UnityMMO.EffectStatus[] array = obj as UnityMMO.EffectStatus[];
				translator.PushUnityMMOEffectStatus(L, array[index]);
				return true;
			}
