...
namespace XLua.CSObjectWrap
{
    ...
    public class CocosRotateByWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Cocos.RotateBy);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Cocos.RotateBy gen_ret = new Cocos.RotateBy();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Cocos.RotateBy constructor!");
        ...
        static int _m_Create_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& translator.Assignable<Cocos.CoordinateStyle>(L, 3)) 
                {
                    ...
                    UnityEngine.Vector3 _deltaRotation;translator.Get(L, 2, out _deltaRotation);
                    Cocos.CoordinateStyle _style;translator.Get(L, 3, out _style);
                    
                        Cocos.RotateBy gen_ret = Cocos.RotateBy.Create( _duration, _deltaRotation, _style );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)&& translator.Assignable<UnityEngine.Vector3>(L, 2)) 
                {
                    ...
                    UnityEngine.Vector3 _deltaRotation;translator.Get(L, 2, out _deltaRotation);
                        ...
                        Cocos.RotateBy gen_ret = Cocos.RotateBy.Create( _duration, _deltaRotation );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Cocos.RotateBy.Create!");
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector3 _deltaRotation;translator.Get(L, 2, out _deltaRotation);
                        ...
                        Cocos.RotateBy gen_ret = Cocos.RotateBy.CreateLocal( _duration, _deltaRotation );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector3 _deltaRotation;translator.Get(L, 2, out _deltaRotation);
                        ...
                        Cocos.RotateBy gen_ret = Cocos.RotateBy.CreateAbs( _duration, _deltaRotation );
                        translator.Push(L, gen_ret);
        ...
        static int _m_Clone(RealStatePtr L)
        {
		    try {
                ...
                Cocos.RotateBy gen_to_be_invoked = (Cocos.RotateBy)translator.FastGetCSObj(L, 1);
