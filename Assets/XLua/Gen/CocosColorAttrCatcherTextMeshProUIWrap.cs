...
namespace XLua.CSObjectWrap
{
    ...
    public class CocosColorAttrCatcherTextMeshProUIWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Cocos.ColorAttrCatcherTextMeshProUI);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Cocos.ColorAttrCatcherTextMeshProUI gen_ret = new Cocos.ColorAttrCatcherTextMeshProUI();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Cocos.ColorAttrCatcherTextMeshProUI constructor!");
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Transform _target = (UnityEngine.Transform)translator.GetObject(L, 1, typeof(UnityEngine.Transform));
                        ...
                        UnityEngine.Color gen_ret = Cocos.ColorAttrCatcherTextMeshProUI.GetColorFunc( _target );
        ...
        static int _m_SetColorFunc_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    Cocos.ColorAttrCatcherTextMeshProUI.SetColorFunc( _target, _color );
        ...
        static int _g_get_GetColor(RealStatePtr L)
        {
		    try {
                ...
                Cocos.ColorAttrCatcherTextMeshProUI gen_to_be_invoked = (Cocos.ColorAttrCatcherTextMeshProUI)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_Ins(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, Cocos.ColorAttrCatcherTextMeshProUI.Ins);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_Ins(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    Cocos.ColorAttrCatcherTextMeshProUI.Ins = (Cocos.ColorAttrCatcherTextMeshProUI)translator.GetObject(L, 1, typeof(Cocos.ColorAttrCatcherTextMeshProUI));
