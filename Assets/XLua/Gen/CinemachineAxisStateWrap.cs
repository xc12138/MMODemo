...
namespace XLua.CSObjectWrap
{
    ...
    public class CinemachineAxisStateWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 4, 15, 14);
			
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Validate", _m_Validate);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Reset", _m_Reset);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetInputAxisProvider", _m_SetInputAxisProvider);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Update", _m_Update);
			
			
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "HasInputProvider", _g_get_HasInputProvider);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "m_SpeedMode", _g_get_m_SpeedMode);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "m_SpeedMode", _s_set_m_SpeedMode);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetInputAxisProvider(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    Cinemachine.AxisState.IInputAxisProvider _provider = (Cinemachine.AxisState.IInputAxisProvider)translator.GetObject(L, 3, typeof(Cinemachine.AxisState.IInputAxisProvider));
                    
                    gen_to_be_invoked.SetInputAxisProvider( _axis, _provider );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_HasInputProvider(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                Cinemachine.AxisState gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.HasInputProvider);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_m_SpeedMode(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                Cinemachine.AxisState gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.Push(L, gen_to_be_invoked.m_SpeedMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_m_SpeedMode(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                Cinemachine.AxisState gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                Cinemachine.AxisState.SpeedMode gen_value;translator.Get(L, 2, out gen_value);
				gen_to_be_invoked.m_SpeedMode = gen_value;
