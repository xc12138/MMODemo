...
namespace XLua.CSObjectWrap
{
    ...
    public class CocosIColorAttrCatcherWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Cocos.IColorAttrCatcher);
        ...
        {
            return LuaAPI.luaL_error(L, "Cocos.IColorAttrCatcher does not have a constructor!");
        }
        ...
        static int _g_get_GetColor(RealStatePtr L)
        {
		    try {
                ...
                Cocos.IColorAttrCatcher gen_to_be_invoked = (Cocos.IColorAttrCatcher)translator.FastGetCSObj(L, 1);
