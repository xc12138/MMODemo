...
namespace XLua.CSObjectWrap
{
    ...
    public class CocosRepeatForeverWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Cocos.RepeatForever);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Cocos.RepeatForever gen_ret = new Cocos.RepeatForever();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Cocos.RepeatForever constructor!");
        ...
        static int _m_Create_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    Cocos.ActionInterval _action = (Cocos.ActionInterval)translator.GetObject(L, 1, typeof(Cocos.ActionInterval));
                    
                        Cocos.RepeatForever gen_ret = Cocos.RepeatForever.Create( _action );
                        translator.Push(L, gen_ret);
        ...
        static int _m_Clone(RealStatePtr L)
        {
		    try {
                ...
                Cocos.RepeatForever gen_to_be_invoked = (Cocos.RepeatForever)translator.FastGetCSObj(L, 1);
