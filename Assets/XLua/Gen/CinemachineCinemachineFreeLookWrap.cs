...
namespace XLua.CSObjectWrap
{
    ...
    public class CinemachineCinemachineFreeLookWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 8, 17, 16);
			
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetRig", _m_GetRig);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "UpdateInputAxisProvider", _m_UpdateInputAxisProvider);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_UpdateInputAxisProvider(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.UpdateInputAxisProvider(  );
